...
faster
Working with memory and HDD files
and performing automatic analysis

Using automation tools, which extract
sensitive information and present the
findings to the researcher

• File Analysis: Memory, HDD, and
general files.
• Using carvers to extract sensitive
information.
• Analyzing memory using Volatility.
• All information should be saved in
an easy way for the investigator to
work.
...
**Network_Security: Domain Mapper**
